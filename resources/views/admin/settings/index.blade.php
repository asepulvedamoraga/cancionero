...
@section('content')
<div class="app-page-header"><div><h1>Configuración</h1><p>Administra usuarios y opciones generales del cancionero.</p></div></div>
<div class="row g-4">
@foreach([
...
<div class="col-md-6"><a class="card card-body h-100 app-settings-card" href="{{ $option['route'] }}"><i class="bi {{ $option['icon'] }}"></i><div><h2>{{ $option['title'] }}</h2><p>{{ $option['text'] }}</p></div><i class="bi bi-chevron-right ms-auto"></i></a></div>
@endforeach
</div>
@endsection